...
public class DummyGenerator {
    ...
    public void createDummy(){
        ...
        if(!allAdvertByUser.isEmpty())
            dummyProductType = createDummyProduct(companyUser2, allAdvertByUser.get(0));
     ...
     * @param advert
     */
    public ProductType createDummyProduct(User user, Advert advert){
